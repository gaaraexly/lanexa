...
export const StarIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.324l5.58.512a.563.563 0 0 1 .31.95l-4.252 3.9a.563.563 0 0 0-.162.531l1.205 5.52a.563.563 0 0 1-.812.622l-4.93-2.88a.563.563 0 0 0-.527 0l-4.93 2.88a.563.563 0 0 1-.812-.622l1.205-5.52a.563.563 0 0 0-.162-.531L.487 10.396a.563.563 0 0 1 .31-.95l5.58-.512a.562.562 0 0 0 .475-.324L11.48 3.5Z" />
    </svg>
);
